...
object TranslationChain {
  ...
  def apply(texts: Seq[String], lang: String = defaultLang, chain: Seq[String] = defaultChain)(implicit as: ActorSystem, ex: ExecutionContext): Future[Map[String, String]] = {
...
//    println(fullChain)
  ...
  def step(translations: Map[String, String], src: String, dest: String)(implicit as: ActorSystem, ex: ExecutionContext): Future[Map[String, String]] = {
